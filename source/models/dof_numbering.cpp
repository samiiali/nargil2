...
nargil::implicit_HDG_dof_numbering<dim, spacedim>::options()
{
  return (model_options::options)(model_options::implicit_time_integration |
                                  model_options::HDG_dof_numbering);
}

template <int dim, int spacedim>
template <typename ModelType, typename ModelEq>
void nargil::implicit_HDG_dof_numbering<dim, spacedim>::count_globals(
  ModelType *in_model)
{
